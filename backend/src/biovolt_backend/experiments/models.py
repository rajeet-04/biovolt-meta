...
class ExperimentArm(Base):
    ...
    adaptive_initial_pwm: Mapped[int | None] = mapped_column(Integer, nullable=True)
    adaptive_pwm_min: Mapped[int | None] = mapped_column(Integer, nullable=True)
    adaptive_pwm_max: Mapped[int | None] = mapped_column(Integer, nullable=True)
    adaptive_pwm_step: Mapped[int | None] = mapped_column(Integer, nullable=True)
    adaptive_settle_ms: Mapped[int | None] = mapped_column(Integer, nullable=True)
    adaptive_minimum_valid_samples: Mapped[int | None] = mapped_column(Integer, nullable=True)
    adaptive_deadband_fraction: Mapped[float | None] = mapped_column(nullable=True)
    adaptive_mixer_policy: Mapped[str | None] = mapped_column(String(16), nullable=True)
    adaptive_mixer_period_ms: Mapped[int | None] = mapped_column(Integer, nullable=True)
    adaptive_mixer_on_ms: Mapped[int | None] = mapped_column(Integer, nullable=True)
